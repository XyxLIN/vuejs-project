...
//            var imgHTML = ''; if(index<0){ return word; } 
//            if (isNoGif) { if(index>104){ return word; } 
//            imgHTML = `<i class="static-emotion" style="background:url(https://res.wx.qq.com/mpres/htmledition/images/icon/emotion/default218877.gif) ${backgroundPositionX}px 0;"></i>` } else { var path = index>104 ? '/img' : 'https://res.wx.qq.com/mpres/htmledition/images/icon'; 
//            imgHTML = `![](${path}/emotion/${index}.gif)` } return imgHTML; }); 
//            return text; } 
//            Vue.directive('emotion', { bind: function (el, binding) {
