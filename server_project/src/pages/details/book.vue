<template>
 <div class="book-content">
  ...
  <el-form-item v-if= " films" label="| 订单价格">
    <el-select style="margin-left:-1.19rem"  v-model = "films.minimumPrice" placeholder="请选择订单区域">
  ...
  <el-form-item class="el_submit">
    ...
    <router-link tag="button" :to = "{name:'cart'}" class="el_button" type="primary"  @click="onSubmit">立即创建</router-link>
